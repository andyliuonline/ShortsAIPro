            ...
            <div className="py-6">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    {view === 'history' ? (
                                ...
                                <div className="space-y-8">
                                    <div className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 p-8 rounded-3xl h-full flex flex-col shadow-sm">
                                        <div className="flex items-center gap-2 mb-8">
                                            ...
                                            <h4 className="text-xl font-bold text-gray-900 dark:text-white">近期成就</h4>
                                        </div>

                                        <div className="flex-1 space-y-4">
                                            {gamificationData.achievements.slice(0, 3).map((achievement: any) => (
                                            ...
                                            <button onClick={() => setView('achievements')} className="w-full py-3 rounded-xl border border-dashed border-gray-300 dark:border-zinc-700 text-gray-400 text-xs font-bold hover:text-gray-600 transition-all">查看全部成就</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="space-y-8">
                            <div className="text-center max-w-2xl mx-auto mb-12">
                                <h3 className="text-4xl font-black text-gray-900 dark:text-white mb-4">我的成就與成長</h3>
                                <p className="text-gray-500 dark:text-zinc-500">追蹤您的創作進度，解鎖更多專屬勳章！</p>
                            </div>
                            ...
                            <div className="max-w-4xl mx-auto">
                                <div className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 p-10 rounded-[3rem] shadow-xl">
                                    <div className="flex items-center gap-3 mb-10">
                                        <Award className="text-orange-500 dark:text-orange-400" size={32} />
                                        <h4 className="text-2xl font-black text-gray-900 dark:text-white">我的勳章館</h4>
                                    </div>

                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                        {gamificationData.achievements.length > 0 ? gamificationData.achievements.map((achievement: any) => (
                                            <div key={achievement.id} className="group p-6 rounded-3xl bg-gray-50 dark:bg-zinc-950 border border-gray-100 dark:border-zinc-800 hover:border-orange-400/50 transition-all flex items-center gap-5 shadow-sm">
                                                <div className="w-16 h-16 rounded-2xl bg-orange-400/10 flex items-center justify-center text-orange-600 dark:text-orange-400 group-hover:scale-110 transition-transform">
                                                    <Medal size={32} />
                                                </div>
                                                <div>
                                                    <p className="font-black text-gray-900 dark:text-white text-lg">{achievement.badge_name}</p>
                                                    <p className="text-sm text-gray-500 dark:text-zinc-500 leading-tight mt-1">{achievement.description}</p>
                                                </div>
                                            </div>
                                        )) : (
                                            <div className="col-span-full flex flex-col items-center justify-center text-gray-300 dark:text-zinc-600 py-10 text-center">
                                                <div className="w-20 h-20 rounded-full bg-gray-100 dark:bg-zinc-800 flex items-center justify-center mb-6 opacity-20">
                                                    <Award size={48} />
                                                </div>
                                                <p className="text-lg font-bold">尚未解鎖勳章，趕快開始您的第一次製作吧！</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
                            ...
                            <div className="py-8 px-6 relative text-center rounded-[3.5rem] bg-white/40 dark:bg-transparent border border-white dark:border-transparent shadow-xl shadow-gray-200/50 dark:shadow-none backdrop-blur-sm">
                                ...
                                <div className="max-w-3xl mx-auto relative z-10">
                                    ...
                                    <div className="relative group max-w-2xl mx-auto">
                                        ...
                                        {showFilters && (
                                            <div className="relative mt-6 bg-white/60 dark:bg-zinc-900/60 border border-white dark:border-zinc-800 rounded-[2.5rem] p-8 grid grid-cols-1 sm:grid-cols-2 gap-8 shadow-xl backdrop-blur-2xl z-50 animate-in fade-in slide-in-from-top-6 duration-500">
